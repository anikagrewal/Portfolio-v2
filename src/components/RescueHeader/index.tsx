...
export default function RescueHeader() {
    return(
        <div className={`flex bg-darkBlue w-full h-header flex-col justify-center items-center lg:flex-row lg:gap-32` }>
            ...
            <p className={`text-lightBlue text-center lg:w-96 lg:text-lbase`}>Rescue Radar is Typescript-based web app, providing individuals the chance to explore all adoptable dogs and take a quiz to find their best breed match.</p>
<div className={`flex flex-col gap-3 lg:flex-row lg:gap-10`}>
<p className={`text-lightBlue font-bold lg:text-lbase`}>Roles: Developer</p>
<p className={`text-lightBlue font-bold lg:text-lbase`}>Time Frame: Feb 2024 - Current</p>
</div>
