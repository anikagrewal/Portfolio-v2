...
export default function Mascots() {
    return(
        <div>
            <p className={`pl-5 mb-8 mt-4 lg:w-imgW`}>The users have the option to customize their mascot so that they can feel that there is a personalized companion that is following and guiding them through their mental health journey.</p>
