...
export default function CaseHeader() {
    return(
        <div className={`flex bg-darkBlue w-full h-header flex-col justify-center items-center lg:flex-row lg:gap-32` }>
            ...
            <p className={`text-lightBlue text-center lg:w-96 lg:text-lbase`}>Innersight is a journal app that utilizes artificial intelligence to help find problems in your day to day life and give insights on how to covercome these struggles.
Your personal mental health compaion.</p>
<div className={`flex flex-col gap-3 lg:flex-row lg:gap-10`}>
<p className={`text-lightBlue font-bold lg:text-lbase`}>Roles: Project Manager & Developer</p>
<p className={`text-lightBlue font-bold lg:text-lbase`}>Time Frame: Sept 2023 - Ongoing</p>
</div>
