  ...
  return (
    ...
    >
     ...
     <p className={`pl-5 pr-5 lg:pl-32 lg:pr-32 mb-8 mt-4 lg:text-lbase`}>PagePal, is a personal library management web app developed using React and powered by the Google Books API. 
      ...
      <Image src={'/images/page1.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`} />
      <p className={`pt-8 lg:text-lbase`}>The home page of the individual's library shows each shelf that they have created. </p>
      </div>
      <div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
      <Image src={'/images/page3.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
      <p className={`pt-8 lg:text-lbase`}>This simplistic search page allows individual's to quickly search by author, book title, or genre</p>
      </div>
      <div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
      <Image src={'/images/page2.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
      <p className={`pt-8 lg:text-lbase`}>The shelf page features the books that have been added, while allowing the individual to choose to add or remove books and change the name of the shelf.</p>
      </div>
      </div>
