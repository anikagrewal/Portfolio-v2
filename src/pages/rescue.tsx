...
<Image src={'/images/rescueAvailable.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`} />
<p className={`pt-8 lg:text-lbase`}>The view adoptable dogs page allows individuals to filter by breed, age, size, gender, and who the dog is good with. </p>
</div>
<div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
<Image src={'/images/rescueQuiz.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
<p className={`pt-8 lg:text-lbase`}>The quiz has multiple questions allowing for the individual to find the best possible match to a breed that would work for both the breed and the individual.</p>
</div>
<div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
<Image src={'/images/rescueGraph.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
<p className={`pt-8 lg:text-lbase`}>The chart aids in showcasing the benefits of dog ownership.</p>
</div>
</div>
      </div>
...
<div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
<Image src={'/images/rescueAvailable.png'} alt="chart" width={500} height={700} className={`rounded-lg shadow-2xl shadow-darkGreen`} />
...
<div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
<Image src={'/images/rescueQuiz.png'} alt="chart" width={500} height={700} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
...
<div className={`flex flex-col gap-3 justify-center items-center p-6 lg:w-textW`}>
<Image src={'/images/rescueGraph.png'} alt="chart" width={500} height={700} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
<p className={`lg:text-lbase`}>The chart aids in showcasing the benefits of dog ownership.</p>
</div>
</div> */ 

/* <div  className={`flex flex-col gap-10 justify-center items-center mb-8 lg:flex-row lg:gap-10`} >
      <div>
     <Image src={'/images/rescueAvailable.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`} />
     <p className={` pt-8 px-8 lg:text-lbase`}>The view adoptable dogs page allows individuals to filter by breed, age, size, gender, and who the dog is good with. </p>
     </div>
     <div>
     <Image src={'/images/rescueQuiz.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
     <p className={`pt-8  px-8 lg:text-lbase`}>The quiz has multiple questions allowing for the individual to find the best possible match to a breed that would work for both the breed and the individual.</p>
     </div>
     <div>
     <Image src={'/images/rescueGraph.png'} alt="chart" width={350} height={350} className={`rounded-lg shadow-2xl shadow-darkGreen`}/>
     <p className={`pt-8  px-8 lg:text-lbase`}>The chart aids in showcasing the benefits of dog ownership.</p>
     </div>
     </div> */