    ...
    >
      ...
      <div>
        ...
        <div className={`flex flex-col justify-center items-center gap-10 mt-5`}>
          <hr className={`border-2 border-yellow w-96 lg:w-siteW`}></hr>
          <div className={`flex flex-col gap-5 text-center`}>
          <h1 className={`text-h1 font-bold`}>24%</h1>
          <p className={`lg:text-lbase lg:w-siteW`}>In just three years, drug claims in Canada for treating mental disorders among those aged 30 and under soared by a staggering 24%</p>
          </div>
        ...
        <p className={`pl-5 lg:pl-32 mb-8 mt-4 lg:w-imgW lg:text-lbase`}>Findings from interview questions and secondary research:</p>
        <Research/>
